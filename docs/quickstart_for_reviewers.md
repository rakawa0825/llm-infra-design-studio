...
Use this path for a 5-10 minute review:
...
10. [Artifact Generation Contract](artifacts/artifact_generation_contract.md)
11. [Text Document Output Templates](artifacts/text_document_output_templates.md)
